  ...
  const signup = (event) => {
    ...
    return (
      <div className="container" id="successpage-container">
        ...
        <div class="container" id="successpage-container">
          <div class="container">
            <div class="col-md-4">
          ...
          <div class="container" id="success-input">
            <div>
              <input class="btn btn-outline-secondary" type="button" value="Add to Google"/>
            </div>
            <div >
              <input class="btn btn-outline-secondary" type="button" value="Add to Calendly"/>
            </div>
          </div>
        </div>
      </div>    
